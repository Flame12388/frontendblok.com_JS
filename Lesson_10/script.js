...
//'false'.
// let num = '5';
// if(num == 5){  //сравниваются только значения, тип переменной не играет роли.
//     console.log(true);
// }else{
//     console.log(false);
// }

// if(num === 5){  // '===' сравнивает и значение, и тип переменной. Если один из параметров не совпадает, результатом будет 'false'
//     console.log(true);
// }else{
//     console.log(false);
// }
...
if (minute >= 0 && minute <= 15){
    ...
    console.log('Введено неверное значение - внимательнее читайте условия!');
}
// Пример 2
...
if(num > 0){
    alert("Число " + "'" + num + "' - " + num.length +"-значное, положительное.");
}else if(num < 0){
        alert("Число " + "'" + num + "' - " + num.length  +"-значное, отрицательное.");
}else{
    alert("Число " + "'" + num + "' - " + num.length +"-значное, не является ни отрицательным, ни положительным числом.");
}
...
if(red == "нет" && yellow  == "нет"){
    console.log("Горит зелёный  - можете переходить дорогу.");
}else{
    console.log("Дождитесь зелёного сигнала светфора!");
}
